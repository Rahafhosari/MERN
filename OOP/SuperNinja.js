...
class Sensei extends Ninja {
    ...
    showStatsInherited(){
        const showStatsInherited = super.showStats(); //parentFunction()
        console.log(showStatsInherited);
    }
}
...
console.log("Inherited Method from Parent Class")
L.showStatsInherited();