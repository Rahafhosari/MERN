...
//but is speed and strength were added in the constructor attributes their values will over ride.
//constructor(name,health,speed = 3,strength= 3){
    // this.name = name;
    // this.health = health;
    // this.speed = speed;
    ...
    //will be cahnged from 3 to 50 as we defined for thh instance
